    ...
    <>
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <Link className="nav-item" to="/playground" style={{ display: 'flex', alignItems: 'center' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--cemer-turk)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '8px' }}><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
            AR Sahne Kurucu
          </Link>
        </nav>
                  ...
                  <div className="model-card" key={m.id}>
                    ...
                    <div className="model-body">
                      ...
                      <div className="model-actions">
                        <Link to={`/upload?edit=${encodeURIComponent(m.name)}`} className="btn-sm" style={{ background: 'var(--bg2)', display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg> Düzenle
                        </Link>
                        <Link to={`/viewer?model=${m.name}`} target="_blank" className="btn-sm" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg> Gözat
                        </Link>
                        <button className="btn-sm" style={{ background: 'var(--bg2)', display: 'inline-flex', alignItems: 'center', gap: '5px' }} onClick={() => handleDownloadGLB(m.name)} title="GLB İndir">
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg> İndir
                        </button>
                        <button className="btn-sm danger" onClick={() => handleDeleteModel(m.id, m.name)} title="Sil" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                      ...
                      >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg> Paylaş & QR
                      </button>
                    </div>
                  </div>
                );
